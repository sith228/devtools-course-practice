...
double Triangle::GetCoordXÑircumscribedÑircle() const {
...
double Triangle::GetCoordYÑircumscribedÑircle() const {
...
double Triangle::GetCoordXInscribedÑircle() const {
    double result_coordX = 0;
    double side1, side2, side3;
    side1 = CalculateSide(1);
    side2 = CalculateSide(2);
...
double Triangle::GetCoordYInscribedÑircle() const {
    double result_coordY = 0;
    double side1, side2, side3;
    side1 = CalculateSide(1);
    side2 = CalculateSide(2);
