...
TEST(test_symbolic_derivative, Can_Parse_Simple_Expression_With_Function) {
  EXPECT_NO_THROW(symbolic_function sym("a + b*c/sin(d)"));
}

TEST(test_symbolic_derivative, Cant_Parse_Expression_With_Unknown_Token) {
  EXPECT_ANY_THROW(symbolic_function sym("a $ b"));
}

TEST(test_symbolic_derivative, Can_Parse_Expression_With_Right_Braces) {
  EXPECT_NO_THROW(symbolic_function sym("(a + b)"));
}

TEST(test_symbolic_derivative, Cant_Parse_Expression_With_Wrong_Braces) {
  EXPECT_ANY_THROW(symbolic_function sym("(a + b"));
}

TEST(test_symbolic_derivative,
...
TEST(test_symbolic_derivative, Can_Parse_Its_Own_Representation) {
...
TEST(test_symbolic_derivative, Derivative_Of_Not_X_Is_Zero) {
